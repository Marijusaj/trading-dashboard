...
// Strategic cron is daily at 12:00 UTC. Throttle 20h so the daily run
// fires reliably even after schedule transitions or one-off force runs.
// Override with ?force=1.
const STRATEGIC_THROTTLE_MINUTES = 20 * 60;
